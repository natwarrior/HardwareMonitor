...
namespace TemperatureAlertSystem.Domain
{
    public class TemperatureWatcher
    {
        ...
        public const int DEFAULT_TEMPERATURE_ALERT_THRESHOLDONE = 45;
        public const int DEFAULT_TEMPERATURE_ALERT_THRESHOLDTWO = 105;
        ...
        public float temperaturealertthresholdone { get; private set; }
        public float temperaturealertthresholdtwo { get; private set; }
        ...
        public TemperatureWatcher()
        {
            ...
            temperaturealertthresholdone = DEFAULT_TEMPERATURE_ALERT_THRESHOLDONE;
            temperaturealertthresholdtwo = DEFAULT_TEMPERATURE_ALERT_THRESHOLDTWO;
        ...
        private void watch()
        {
            while (_watchTemperatures)
            {
                if (_timeoutBuffer >= CheckTemperatureTimeoutMillis)
                {
                    ...
                    LastMeasuredTemperature = avgTemperature-10;
        ...
        public delegate void ActiveSystemCoolingPolicy();

        public event ActiveSystemCoolingPolicy OnThresholdOneDetection;
